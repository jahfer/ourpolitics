...
module Strings = {
  ...
  let environment = {
    en: "Environment",
    fr: {js|Environnement|js}
  };
  let government = {
    en: "Government",
    fr: {js|Gouvernement|js}
  };
  ...
  let healthcare = {
    en: "Health Care",
    fr: {js|Soins de santé|js}
  };
  let infrastructure = {
    en: "Infrastructure",
    fr: {js|Infrastructures|js}
  };
  let science = {
    en: "Science",
    fr: {js|Science|js}
  ...
  let child_care = {
    en: "Child Care",
    fr: {js|Soin des enfants|js}
  };
  let bill_c51 = {
    en: "Bill C-51",
    fr: {js|Projet de loi C-51|js}
  };
  let cannabis = {
    en: "Cannabis",
    fr: {js|Cannabis|js}
